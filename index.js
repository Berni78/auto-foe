...
var createService = function(userData) {
	...
	const cityMapService = require('./server/CityMapService').get(userData, definitionService, resourceService, apiService); serviceArray.push(cityMapService);
	const cityResourcesService = require('./server/CityResourcesService').get(userData, apiService, cityMapService); serviceArray.push(cityResourcesService);
